...
void PluginInit() 
{
    g_Module.ScriptInfo.SetAuthor("Chaotic Akantor");
    g_Module.ScriptInfo.SetContactInfo("Created for SCRPG Mod");
...
HookReturnCode OnWeaponTertiaryAttack(CBasePlayer@ pPlayer, CBasePlayerWeapon@ pWeapon) 
{
    ...
    {
        string steamId = g_EngineFuncs.GetPlayerAuthId(pPlayer.edict());
        bool currentMode = bool(g_ExplosiveMode[steamId]);
        ...
        g_PlayerFuncs.ClientPrint(pPlayer, HUD_PRINTTALK, 
            "Explosive rounds: " + (bool(g_ExplosiveMode[steamId]) ? "ENABLED" : "DISABLED") + "\n");
