namespace Populate
{
	void PopulateSkills()
	{
		...
		g_SkillMenu.AddItem( Menu::CPlayerSkill( "Explosive Regen", Menu::SKILL_EXPLOSIVEREGEN, AB_EXPLOSIVE_MAX ) );
		g_SkillMenu.AddItem( Menu::CPlayerSkill( "Double Jump", Menu::SKILL_DOUBLEJUMP, AB_DOUBLEJUMP_MAX ) );
		g_SkillMenu.AddItem( Menu::CPlayerSkill( "First Aid (Skill)", Menu::SKILL_FIRSTAID, AB_FIRSTAID_MAX ) );
		g_SkillMenu.AddItem( Menu::CPlayerSkill( "Shock Rifle (Skill)", Menu::SKILL_SHOCKRIFLE, AB_SHOCKRIFLE_MAX ) );
