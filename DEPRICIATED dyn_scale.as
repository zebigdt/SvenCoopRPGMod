...
const float DYNSCALE_PLAYER = 1.00f; //Default 0.05f - Per player scaling?
const float DYNSCALE_NPC = 1.00f; //Default 0.25f - NPC Health
const float DYNSCALE_BULLET = 1.00f; //Default 0.25f - Bullet Damage
const float DYNSCALE_DAMAGE = 1.00f; //Default 11.0f - Monster Damage

final class CDynamicDifficulty
{
	// Defaults
		//NPC Health and Damage Values
	...
	private array<double> sk_vars_def = {
		...
		20.0, // sk_agrunt_dmg_punch
		256.0, // sk_agrunt_melee_engage_distance
		30.0, // sk_agrunt_berserker_dmg_punch
		500.0, // sk_apache_health
		50.0, // sk_barnacle_health
		8.0, // sk_barnacle_bite
		65.0, // sk_barney_health
		110.0, // sk_bullsquid_health
		25.0, // sk_bullsquid_dmg_bite
		45.0, // sk_bullsquid_dmg_whip
		...
		50.0, // sk_gargantua_dmg_slash
		4.0, // sk_gargantua_dmg_fire
		100.0, // sk_gargantua_dmg_stomp
		50.0, // sk_hassassin_health
		20.0, // sk_headcrab_health
		10.0, // sk_headcrab_dmg_bite
		...
		25.0, // sk_babygargantua_dmg_slash
		2.0, // sk_babygargantua_dmg_fire
		...
		25.0, // sk_zombie_barney_dmg_one_slash
		40.0, // sk_zombie_barney_dmg_both_slash
		150.0, // sk_zombie_soldier_health
		50.0, // sk_zombie_soldier_dmg_one_slash | Default in skill.cfg is 40
		75.0, // sk_zombie_soldier_dmg_both_slash | Default in skill.cfg is 55
		...
		25.0, // sk_pitdrone_dmg_bite
		25.0, // sk_pitdrone_dmg_whip
		15.0, // sk_pitdrone_dmg_spit
		200.0, // sk_shocktrooper_health
		12.0, // sk_shocktrooper_kick
		10.0, // sk_shocktrooper_maxcharge
		800.0, // sk_tor_health
		55.0, // sk_tor_punch
		...
		25.0, // sk_kingpin_lightning
		15.0, // sk_kingpin_tele_blast
		80.0, // sk_kingpin_plasma_blast
		40.0, // sk_kingpin_melee
		500.0 // sk_kingpin_telefrag
	};
		//NPC Bullet Damage
	private array<double> sk_vars_bullets_def = {
		12.0, // sk_12mm_bullet | Default 0.5
		6.0, // sk_9mmAR_bullet | Default 0.3
		9.0, // sk_9mm_bullet | Default 0.3
		10.0, // sk_hornet_dmg | Default 0.3
		34.0, // sk_otis_bullet | Default 0.4
		6.0, // sk_grunt_buckshot | Default 0.5
		15.0 // sk_556_bullet | Default 0.23 | Exception, governs NPC and Player
	};
	...
	private void CalculatePlayers()
	{
		...
		int max = 0;
		int iPlayers = 0;
		float flTempScale = 1.00f; //Default 0.25f
		...
		flMonsterDamage_Scale = (flTempScale*iPlayers); //Reversed to multiply instead
		...
		// Now do the same for monster damage scale
		// Except, we will divide the result - But it multiplies here?!
	...
	void UpdateDynamicScale()
	{
		...
		for( int i = 0; i < iMax; ++i )
		{
			double dblScale = 1.0; // Default 11.0
		...
		for( int i = 0; i < iMax; ++i )
		{
			double dblScale = 1.0; // Default 1.5
...
void DynScale_RegisterHooks()
{
	...
	@g_dynscale_bonus_score = CCVar("dynscale_bonus_score", 0, "The amount of bonus score you get (base score)\n\tThe higher the difficulty, this will be multiplied by dynscale_bonus_multiply", ConCommandFlag::AdminOnly); //Default 20
	@g_dynscale_bonus_multiply = CCVar("dynscale_bonus_multiply", 0.00f, "The amount we should multiply with (from amount of players)", ConCommandFlag::AdminOnly); //Default 11.5f
	@g_dynscale_amount = CCVar("dynscale_amount", 1.00f, "The amount to scale Base NPC Health and Damage", ConCommandFlag::AdminOnly); //Default 0.35f
	@g_dynscale_amount_bullets = CCVar("dynscale_amount_bullets", 1.00f, "The amount to scale Base NPC Bullet Damage", ConCommandFlag::AdminOnly); //Default 0.22f
	@g_dynscale_amount_player = CCVar("dynscale_amount_player", 1.00f, "The amount to scale Player Damage Taken", ConCommandFlag::AdminOnly); //Default 0.012f
	@g_dynscale_amount_player_max = CCVar("dynscale_amount_player_cap", 8, "The cap amount (amount of players)", ConCommandFlag::AdminOnly); //Default 8
	@g_dynscale_amount_monster = CCVar("dynscale_amount_monster", 1.00f, "The amount to scale Monster Damage Taken", ConCommandFlag::AdminOnly); //Default 1.5f
	@g_dynscale_amount_monster_max = CCVar("dynscale_amount_monster_cap", 8, "The cap amount (amount of players)", ConCommandFlag::AdminOnly); //Default 5
}